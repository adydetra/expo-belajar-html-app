...
export default function PersiapanPage() {
  return (
    ...
    <View style={tw`px-3.5 my-6` }>
      ...
      <Text style={tw`text-sm text-gray-600 mt-2 mb-1 leading-6`}>
      ...
      <Text style={tw`text-sm text-gray-600 mb-2 leading-6`}>
